import { FaUsers, FaTachometerAlt, FaTicketAlt, FaBook, FaCog, FaSignOutAlt } from "react-icons/fa";
...
export const AdminSideBarItems = [
  ...
  },
  {
    ...
    icon: FaBook,
    children: [
      { label: "View Articles", path: PATHS.ADMIN.KNOWLEDGEBASE.path },
      { label: "View Feedback", path: PATHS.ADMIN.VIEW_FEEDBACK.path }, 
    ],
  },
];
