...
const NewTicketSummary: React.FC = () => {
    ...
    return (
        <div className="p-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Overview of ticket data by category, status, priority, and user activity</p>
            </div>
...
export default NewTicketSummary;
